      ...
      <div className="bg-black w-full h-[950px] flex">
        <div className="w-[30%]  bg-gradient-to-r from-[#171616] via-[#2b2a2a] to-[#171616] my-auto mx-auto rounded-xl p-10 text-white">
          ...
          <div className="text-[1.25rem] font-medium">
            Already have an account? <a href="/auth/login" className="hover:underline">Log In</a>
          </div>
          ...
          <input type="password" className="w-full p-2 mb-4 rounded bg-transparent border-[1px]" />
          <button className="w-full p-2 bg-white text-black text-[1.25rem]   font-bold py-2 px-4 rounded border-[1px] border-black hover:border-white hover:bg-black hover:text-white rounded-lg">Sign Up</button>
